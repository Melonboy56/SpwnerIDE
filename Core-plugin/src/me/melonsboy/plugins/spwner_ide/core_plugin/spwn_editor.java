...
public class spwn_editor extends JPanel {
    ...
    public spwn_editor(String filepath, boolean is_template, stringholder contenttext) throws IOException {
        super();
        ...
        add(hidden_save_button,BorderLayout.PAGE_START);
    }
}
